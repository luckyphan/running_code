...
// CODE HERE
let total = netflix + hulu + disneyPlus + youtubePrem + peacock;
console.log(total)
...
// CODE HERE
let newTotal = netflix + hulu + disneyPlus + youtubePrem + peacock;
console.log(total)
...
let rounded = savings.toFixed(6);
console.log("Savings " +rounded);
